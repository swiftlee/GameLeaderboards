...
public class TextAnimations 
{
	...
	public TextAnimations(GameLeaderboards plugin, boolean ipOrTitle, Objective o)
	{
		this.plugin = plugin;
	...
	public void createInitialEntry(Objective o, String text)
	{
		if(created == false)
		{
	...
	void updateEntry(Objective o, String prefix, String text, int delay)
	{
	...
	public void ipAnim(Objective o)
	{
		...
		createInitialEntry(o, "&8hub.royalmc.org");
